<?php
/**
 * Script para gerar o arquivo JavaScript de componentes web
 */

// Definir caminho para o arquivo de saída
$output_file = __DIR__ . '/assets/js/web-components.js';
...
echo "Arquivo de componentes web gerado com sucesso em: $output_file\n";
